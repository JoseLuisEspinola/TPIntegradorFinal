...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Envio el nombre de las personas de este pronostico. LO TENGO QUE MODIFICAR PORQUE MINIMO TIENE QUE SER UN ARRAYLIST. Pero nooo hay tiempo
		...
		*/	
			...
			// INTENTO HACER LO MISMO, PERO NO PUEDO ENCONLUMNAR BIEN. DEBE HABER ALGUNA ORDEN QUE ME PERMITA CONTROLAR LA POSICION EN PANTALLA
		...
		*/
		...
		/*	// Guardo datos de PRONOSTICO - deberia ser en una clase
			for(int i=0; i < listaPronostico.size(); i++) {
				...
				if (i < 1) {
					System.out.println(archivoPronostico[i] + "   " + archivoPronostico[i+1] + "        " + archivoPronostico[i+2] + "          " + archivoPronostico[i+3] + "          " + archivoPronostico[i+4] + "              " + archivoPronostico[i+5]);
				} else {
					System.out.println(archivoPronostico[j] + "        " + archivoPronostico[j+1] + "           " + archivoPronostico[j+2] + "            " + archivoPronostico[j+3] + "            " + archivoPronostico[j+4] + "              " + archivoPronostico[j+5]);
				}
			}
		*/			
			...
			// **************************************************
			if(resulPartido5[1] == "x") {
				if(Objects.equals(resulPartido5[1], pronosticoPartido5.getGana1())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}
			...
			if(resulPartido5[2] == "x") {
				if(Objects.equals(resulPartido5[2], pronosticoPartido5.getEmpate())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}
			...
			if(resulPartido5[3] == "x") {
				if(Objects.equals(resulPartido5[3], pronosticoPartido5.getGana2())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido6[1] == "x") {
				if(Objects.equals(resulPartido6[1], pronosticoPartido6.getGana1())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}
			...
			if(resulPartido6[2] == "x") {
				if(Objects.equals(resulPartido6[2], pronosticoPartido6.getEmpate())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}
			...
			if(resulPartido6[3] == "x") {
				if(Objects.equals(resulPartido6[3], pronosticoPartido6.getGana2())) {
					sumaPuntosM = sumaPuntosM + 1;
				} 
			}			
...
//********************************************************************************************
			...
			// **************************************************
			if(resulPartido1[1] == "x") {
				if(Objects.equals(resulPartido1[1], pronosticoPartido7.getGana1())) {
			...
			if(resulPartido1[2] == "x") {
				if(Objects.equals(resulPartido1[2], pronosticoPartido7.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido1[3] == "x") {
				if(Objects.equals(resulPartido1[3], pronosticoPartido7.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido2[1] == "x") {
				if(Objects.equals(resulPartido2[1], pronosticoPartido8.getGana1())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido2[2] == "x") {
				if(Objects.equals(resulPartido2[2], pronosticoPartido8.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido2[3] == "x") {
				if(Objects.equals(resulPartido2[3], pronosticoPartido8.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido3[1] == "x") {
				if(Objects.equals(resulPartido3[1], pronosticoPartido9.getGana1())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido3[2] == "x") {
				if(Objects.equals(resulPartido3[2], pronosticoPartido9.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido3[3] == "x") {
				if(Objects.equals(resulPartido3[3], pronosticoPartido9.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido4[1] == "x") {
				if(Objects.equals(resulPartido4[1], pronosticoPartido10.getGana1())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido4[2] == "x") {
				if(Objects.equals(resulPartido4[2], pronosticoPartido10.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido4[3] == "x") {
				if(Objects.equals(resulPartido4[3], pronosticoPartido10.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido5[1] == "x") {
				if(Objects.equals(resulPartido5[1], pronosticoPartido11.getGana1())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido5[2] == "x") {
				if(Objects.equals(resulPartido5[2], pronosticoPartido11.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido5[3] == "x") {
				if(Objects.equals(resulPartido5[3], pronosticoPartido11.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido6[1] == "x") {
				if(Objects.equals(resulPartido6[1], pronosticoPartido12.getGana1())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
			...
			if(resulPartido6[2] == "x") {
				if(Objects.equals(resulPartido6[2], pronosticoPartido12.getEmpate())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}

			if(resulPartido6[3] == "x") {
				if(Objects.equals(resulPartido6[3], pronosticoPartido12.getGana2())) {
					sumaPuntosP = sumaPuntosP + 1;
				} 
			}
...
//****************************************************************************************************
			...
			// **************************************************
			if(resulPartido1[1] == "x") {
				if(Objects.equals(resulPartido1[1], pronosticoPartido13.getGana1())) {
			...
			if(resulPartido1[2] == "x") {
				if(Objects.equals(resulPartido1[2], pronosticoPartido13.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido1[3] == "x") {
				if(Objects.equals(resulPartido1[3], pronosticoPartido13.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido2[1] == "x") {
				if(Objects.equals(resulPartido2[1], pronosticoPartido14.getGana1())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido2[2] == "x") {
				if(Objects.equals(resulPartido2[2], pronosticoPartido14.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido2[3] == "x") {
				if(Objects.equals(resulPartido2[3], pronosticoPartido14.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido3[1] == "x") {
				if(Objects.equals(resulPartido3[1], pronosticoPartido15.getGana1())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido3[2] == "x") {
				if(Objects.equals(resulPartido3[2], pronosticoPartido15.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido3[3] == "x") {
				if(Objects.equals(resulPartido3[3], pronosticoPartido15.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido4[1] == "x") {
				if(Objects.equals(resulPartido4[1], pronosticoPartido16.getGana1())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido4[2] == "x") {
				if(Objects.equals(resulPartido4[2], pronosticoPartido16.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido4[3] == "x") {
				if(Objects.equals(resulPartido4[3], pronosticoPartido16.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido5[1] == "x") {
				if(Objects.equals(resulPartido5[1], pronosticoPartido17.getGana1())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido5[2] == "x") {
				if(Objects.equals(resulPartido5[2], pronosticoPartido17.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido5[3] == "x") {
				if(Objects.equals(resulPartido5[3], pronosticoPartido17.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			// **************************************************
			if(resulPartido6[1] == "x") {
				if(Objects.equals(resulPartido6[1], pronosticoPartido18.getGana1())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido6[2] == "x") {
				if(Objects.equals(resulPartido6[2], pronosticoPartido18.getEmpate())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}
			...
			if(resulPartido6[3] == "x") {
				if(Objects.equals(resulPartido6[3], pronosticoPartido18.getGana2())) {
					sumaPuntosJ = sumaPuntosJ + 1;
				} 
			}			
			...
			System.out.println("");
			System.out.println("Se que NO esta DINAMICO, pero el tiempo se me acabo, y debo seguir con el proyecto que el grupo eligio.\nNo obstante seguire 'LUCHANDO' para poder terminarlo como corresponde. Gracias FER, FEDERICO y LUCAS.");
